...
const noNameToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMDg4NTQyNzMzMzE0ODQ4MDg1NTIiLCJlbWFpbCI6InRlc3QudXNlckBoYWNrbmV5Lmdvdi51ayIsImlzcyI6IkhhY2tuZXkiLCJncm91cHMiOlsiYXJlYS1ob3VzaW5nLW1hbmFnZXItZGV2Il0sImlhdCI6MTU5NTM0MzExMH0.7ZRJQHHMCYxJCzJGv2dprWYHXJzJ0KRDW1m1MRru1Kw';

describe("get logged in user's full name from JWT in cookie", () => {

	it(`returns empty string if name if missing`, async () => {
		Cookies.get = jest.fn()
			.mockImplementationOnce(() => noNameToken)
