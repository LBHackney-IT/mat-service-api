...
const noEmailToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMDg4NTQyNzMzMzE0ODQ4MDg1NTIiLCJpc3MiOiJIYWNrbmV5IiwibmFtZSI6IlRlc3QgVXNlciIsImdyb3VwcyI6WyJhcmVhLWhvdXNpbmctbWFuYWdlci1kZXYiXSwiaWF0IjoxNTk1MzQzMTEwfQ.Dc5pz050ER9WVgHsudww5neby2JwSJnkk9KtTAivt7M';

describe("get logged in user's email from JWT in cookie", () => {

	it(`returns empty string if email if missing`, async () => {
		Cookies.get = jest.fn()
			.mockImplementationOnce(() => noEmailToken)
